...
gameFlowUpdateDying
        ...
        bne _flowUpdateDyingEnd

        lda lives
        bne _flowUpdateHasLives

        ; change state
        lda #FlowStateMenu
        sta flowState
        jmp _flowUpdateDyingEnd
...
gameFlowPlayerDied
        ...
        jsr gameEnemiesReset

        dec lives
        bne _gameFlowUpdateHasLivesLeft 
        
        jsr gameFlowUpdateHiScore
        jsr gameFlowResetScore

_gameFlowUpdateHasLivesLeft
        jsr gameFlowLivesDisplay
...
gameFlowUpdateHiScore
        ...
        bcc _gameFlowUpdateNoHighScore
